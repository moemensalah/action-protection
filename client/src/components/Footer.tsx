      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-amber-400">لاونج</h3>
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-amber-400">{t("quickLinks")}</h4>
            <div className="space-y-2">
              <a href="/" className="block text-gray-300 hover:text-amber-400 transition-colors">
                {t("home")}
              </a>
              <a href="/menu" className="block text-gray-300 hover:text-amber-400 transition-colors">
                {t("menu")}
              </a>
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-amber-400">{t("contactInfo")}</h4>
