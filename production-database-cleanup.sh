...
echo ""
echo "📋 Quick cleanup commands (review analysis first):"
echo "   # Remove products with NULL names:"
echo "   DELETE FROM products WHERE name_en IS NULL;"
echo ""
echo "   # Remove specific duplicate IDs:"
echo "   DELETE FROM products WHERE id IN (specific_ids);"
echo ""
